...
function formatDate(value) {
  if (!value) return '-';
  // Se for uma string YYYY-MM-DD ou similar
...
function formatDateTime(value) {
  if (!value) return '-';
  // Trata strings de data/hora do backend
  if (typeof value === 'string') {
    // Se for formato ISO (com ou sem Z), cria a data
    const date = new Date(value);
    // Formatter usando Intl para garantir pt-BR e considerar timezone local
