...
> Atenção: se você abrir `index.html` diretamente no navegador (file://...), o front pode falhar ao conectar à API por causa de CORS. O ideal é usar um servidor estático local ou rodar o front junto com o backend.
